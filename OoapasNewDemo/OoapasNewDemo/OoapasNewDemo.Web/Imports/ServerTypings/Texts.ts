    ...
    declare namespace Db {
        ...
        namespace Usuarios {
            ...
            namespace Catalago {
                ...
                export const Administrador: string;
                export const ClaveAcceso: string;
                export const Cuando: string;
                export const Departamento: string;
                export const DiasCc: string;
                export const Donde: string;
                export const Empleado: string;
                export const Entidad: string;
                export const FecNacimiento: string;
                export const FechaPc: string;
                export const FechaUc: string;
                export const FechaVig: string;
                export const Grupo: string;
                export const InactividadOut: string;
                export const JefeInmediato: string;
                export const NoSesiones: string;
                export const NoSesionesAct: string;
                export const Nombre: string;
                export const NombreAcceso: string;
                export const Obs: string;
                export const Oficina: string;
                export const OficinaOper: string;
                export const PerfilTRep: string;
                export const Puesto: string;
                export const Quien: string;
                export const SubSistema: string;
                export const TelExt: string;
                export const Usuario: string;
                export const Vigencia: string;
            }
        }
    }
