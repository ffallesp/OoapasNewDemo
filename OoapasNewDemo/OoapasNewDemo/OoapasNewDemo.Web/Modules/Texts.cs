...
namespace OoapasNewDemo {
    ...
    public static partial class Texts {
        ...
        public static class Forms {
            public static class Membership {
                ...
                public static class ResetPassword {
                    public static LocalText EmailSubject = "Reset Your OoapasNewDemo Password";
                ...
                public static class SignUp {
                    public static LocalText ActivateEmailSubject = "Activate Your OoapasNewDemo Account";
                    ...
                    public static LocalText FormTitle = "Sign up for OoapasNewDemo";
        ...
        public static class Navigation {
            ...
            public static LocalText SiteTitle = "OoapasNewDemo";
        }
